...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
    ...
    test('Verifica se o objeto retornado tem 3 propriedades', () => {
      expect(Object.values(circle(2)).length).toBe(3);
    });
    // Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.
    test('Verifica se a função retorna undefined quando não recebe parâmetro', () => {
    ...
    test('Verifica se a função retorna uma key com value igual a circunferência correta para um círculo de raio 2', () => {
    ...
    test('Verifica se a função retorna uma key com value igual a área correta para um círculo de raio 3', () => {
      expect(circle(3).area).toBeCloseTo(28.26);
    });
    // Teste que a função retorna, num objeto, os dados corretos de um círculo de raio 3.
    test('Verifica se a função retorna, num objeto, os dados corretos de um círculo de raio 3', () => {
