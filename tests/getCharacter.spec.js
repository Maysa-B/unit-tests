...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  test('Se a função não recebe parametros retorna undefined', () => {
    expect(getCharacter()).toBeUndefined();
  });
  // Teste se a função retorna o objeto correto para o parâmetro 'Arya',
  // Teste se a função retorna o objeto correto para o parâmetro 'Brienne',
  // Teste se a função retorna o objeto correto para o parâmetro 'Melissandre',
  test('Verifica se o objeto retornado está correspondendo com o nome passado', () => {
  ...
  test('Testa se os parâmetros não são Case Sensitive', () => {
    expect(getCharacter('ArYA')).toEqual({
      name: 'Arya Stark',
      class: 'Rogue',
      phrases: ['Not today', 'A girl has no name.'],
